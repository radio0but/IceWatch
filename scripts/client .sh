...
ARCHIVE_URL="https://rosemont.boogiepit.com/index.php/s/FFRJ64XZgLWSo9g/download/PlasmaConfig_20250619_204347.tar.gz"
...
if [[ "$ARGS" == *"--plasma"* ]]; then
    info "Téléchargement de l'archive PlasmaConfig..."
    wget -q --show-progress -O PlasmaConfig.tar.gz "$ARCHIVE_URL"
fi
